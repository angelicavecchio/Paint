...
import com.example.Command.BringBackCommand;
import com.example.Command.BringFrontCommand;
import com.example.Command.ChangeFillColorCommand;
import com.example.Command.ChangeStrokeColorCommand;
import com.example.Command.Command;
import com.example.Command.CommandHistory;
import com.example.Command.DeleteCommand;
import com.example.Command.DragCommand;
import com.example.Command.InsertCommand;
...
import com.example.Factory.ShapeCreator;
...
public class PrimaryController implements Initializable{
 ...
 @FXML
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        undoButton.disableProperty().bind(history.getEmptyProperty());
    ...
    protected void saveFileOperation() {
        ...
        if (file != null) {
            ...
            if (!FileServices.saveFile(shapeList, file.getAbsolutePath())) {
    ...
    protected void loadFileOperation() {
        ...
        if (file != null) {
            if (!file.getName().toLowerCase().endsWith(".txt")) {
                ...
                List<ShapeInterface> shapeList = FileServices.loadFile(file.getAbsolutePath());
